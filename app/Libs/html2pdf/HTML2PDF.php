...
use App\Libs\html2pdf\classes\HTML2PDF_exception;
use App\Libs\html2pdf\classes\HTML2PDF_locale;
use App\Libs\html2pdf\classes\HTML2PDF_myPdf;
use App\Libs\html2pdf\classes\HTML2PDF_parsingCss;
use App\Libs\html2pdf\classes\HTML2PDF_parsingHtml;

//if (!defined('__CLASS_HTML2PDF__')) {

    define('__CLASS_HTML2PDF__', '4.03');
    define('HTML2PDF_USED_TCPDF_VERSION', '5.0.002');
    //require_once(dirname(__FILE__).'/classe/exception.php');
    //require_once(dirname(__FILE__).'/classe/locale.php');
    //require_once(dirname(__FILE__).'/classe/myPdf.php');
    //require_once(dirname(__FILE__).'/classe/parsingHtml.php');
    //require_once(dirname(__FILE__).'/classe/parsingCss.php');
