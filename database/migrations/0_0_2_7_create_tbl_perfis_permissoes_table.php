...
class CreateTblPerfisPermissoesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_perfis_permissoes', function (Blueprint $table) {
            ...
            $table->bigInteger('id_perfil_site_modulo')->unsigned()->nullable();
            $table->foreign('id_perfil_site_modulo')->references('id')->on('tbl_perfis_sites_modulos');
    ...
    {
        Schema::dropIfExists('tbl_perfis_sites_modulos_permissoes');
    }
}
