...
class Tbl_Banner_Seeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('tbl_banners')->insert([
            'id'=>1,
            'nome'=>'Venha conhecer nossa site!',
        ...
        DB::table('tbl_banners')->insert([
            'id'=>2,
            'nome'=>'Venha fazer curso de inglês em nossa site!',
            'descricao'=>'Clique aqui para saber mais sobre nossa localização e contatos.',
        ...
        DB::table('tbl_banners')->insert([
            'id'=>3,
            'nome'=>'Temos a melhor membros de professores!',
            'descricao'=>'Clique aqui para saber mais sobre nossa membros.',
