...
$appRoutes = function() {
        ...
        Route::get('/eventos', 'IgrejaController@eventos')->name('igreja.eventos');
        Route::get('/evento/{id}', 'IgrejaController@evento')->name('igreja.evento');
        Route::get('/inscreveEnvento', 'IgrejaController@inscreveEnvento')->name('igreja.inscreveEnvento');
        Route::get('/eventosfixos', 'IgrejaController@eventosfixos')->name('igreja.eventosfixos');
        Route::get('/eventofixo/{id}', 'IgrejaController@eventofixo')->name('igreja.eventofixo');
        Route::get('/noticias', 'IgrejaController@noticias')->name('igreja.noticias');
        Route::get('/noticia/{id}', 'IgrejaController@noticia')->name('igreja.noticia');
        Route::get('/apresentacao', 'IgrejaController@apresentacao')->name('igreja.apresentacao');
        Route::get('/sermoes', 'IgrejaController@sermoes')->name('igreja.sermoes');
        Route::get('/sermao/{id}', 'IgrejaController@sermao')->name('igreja.sermao');
        Route::get('/galeria','IgrejaController@galeria')->name('igreja.galeria');
        Route::get('/publicacao/{id}','IgrejaController@publicacao')->name('igreja.publicacao');
        Route::get('/login','IgrejaController@login')->name('igreja.login');
...
Route::group(array('domain' => 'cepsma.localhost'), $appRoutes);
