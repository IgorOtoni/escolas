<?php /* C:\xampp\htdocs\apresentacao_escolas\resources\views/carrinho/finalizar.blade.php */ ?>
...
if(isset(\Auth::user()->id_perfil) && \Auth::user()->id_perfil == 100){
    if(null !== \Session()->get('carrinho') && is_array(\Session()->get('carrinho'))){
        ...
        <div id="pgFinalizarPedido">
            ...
            <div>
                <form data-toggle="validator" method="POST" action="<?php echo e(route('igreja.salvarCompra', $igreja->url)); ?>" class="form-group">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group has-feedback">
                                        <input class="form-control" min="<?php echo e(date('Y-m-d')); ?>" name="dtentrega" type="date" required>
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group has-feedback">
                                        <?php foreach ($turnos as $key => $turno): ?>
                                            <div class="class="radio">
                                                <label><input name="turno" type="radio" value="<?php echo e($turno->id); ?>" required> <?php echo e($turno->nome); ?> (<?php echo e($turno->descricao); ?>)</label>
                                            </div>
                                        <?php endforeach ?>
                        ...
                        <div class="panel-footer">
                            <a class="btn btn-danger" href="<?php echo e(route('igreja.finalizarCompra', $igreja->url)); ?>">Cancelar compra</a>
