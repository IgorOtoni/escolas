...
<script src="<?php echo e(asset('template_adm/bower_components/ckeditor/ckfinder/ckfinder.js')); ?>"></script>-->
<!-- InputFilePTBR -->
...
$(function () {
    var table = $('#tbl_publicacoes').DataTable({
        ...
        'autoWidth': false,
        //'serverSide': false,
        'ajax': '<?php echo e(route('usuario.tbl_publicacoes')); ?>',
        'columns': [
                {
...
<?php echo $__env->make('layouts.usuario.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/usuario/publicacoes.blade.php ENDPATH**/ ?>