<?php /* C:\xampp\htdocs\apresentacao_escolas\resources\views/admin/usuarios/index.blade.php */ ?>
...
<div class="modal fade" id="modal-incluir">
  <form id="incluirUsuarioFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('usuarios.incluir')); ?>" enctype="multipart/form-data">
  <?php echo csrf_field(); ?>
