...
$(function(){
    ...
    $('input[name=logo]').fileinput({
        ...
        initialPreview: [
            "<?php echo e('data:image;base64,'.base64_encode($site->logo)); ?>"
        ],
        <?php } ?>
        ...
        initialPreviewConfig: [
            {caption: "<?php echo e($site->logo); ?>", extra: {id: <?php echo e($site->id); ?>, logo: "<?php echo e($site->logo); ?>", _token: $("#csrf_token").val()}, size: 215000, width: "120px", url: "<?php echo e(route('sites.excluirLogo')); ?>", key: 1},
        ],
        <?php } ?>
...
<section class="content">
    ...
    <form id="editarConfiguracoesSiteFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('sites.salvarConfiguracoes')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="box">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group has-feedback">
                <label >Url</label>
                <input name="url" type="text" class="form-control" placeholder="Url" value="<?php echo e($site->url); ?>" required>
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                <div class="help-block with-errors"></div>
                </div>
            </div>
                                    ...
                                    <li>
                                        <div><span><i class="icon-folder-open"></i> <?php echo e($menu->ordem); ?> - <?php echo e($menu->nome); ?></span> 
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <a class="btn btn-danger btn-sm" href="/usuario/sites/excluirMenu/<?php echo e($menu->id); ?>"><i class="fa fa-trash"></i> Menu</a>
                                            </div>
                                        </div>
                                        <ul>
                                                ...
                                                <li>
                                                    <div><span><i class="icon-minus-sign"></i> <?php echo e($submenu->ordem); ?> - <?php echo e($submenu->nome); ?></span>
                                                        ...
                                                        <div class="pull-right">
                                                            ...
                                                            <a class="btn btn-danger btn-sm" href="/usuario/sites/excluirSubMenu/<?php echo e($submenu->id); ?>"><i class="fa fa-trash"></i> Submenu</a>
                                                        </div>
                                                    </div>
                                                    <ul>
                                                            ...
                                                            <li>
                                                                <div><span><i class="icon-leaf"></i> <?php echo e($subsubmenu->ordem); ?> - <?php echo e($subsubmenu->nome); ?></span> 
                                                                    ...
                                                                    <div class="pull-right">
                                                                        ...
                                                                        <a class="btn btn-danger btn-sm" href="/usuario/sites/excluirSubSubMenu/<?php echo e($subsubmenu->id); ?>"><i class="fa fa-trash"></i> Sub-Submenu</a>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        <?php } ?>
                                    ...
                                    <li>
                                        <div><span><i class="icon-folder-open"></i> <?php echo e($menu->ordem); ?> - <?php echo e($menu->nome); ?></span> 
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <a class="btn btn-danger btn-sm" href="/usuario/sites/excluirMenuAplicativo/<?php echo e($menu->id); ?>"><i class="fa fa-trash"></i> Menu</a>
                                            </div>
                                        </div>
                                    </li>
                                <?php } ?>
...
<form id="adicionarMenuFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('sites.adicionarMenu')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
<form id="adicionarSubMenuFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('sites.adicionarSubMenu')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
<form id="adicionarSubSubMenuFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('sites.adicionarSubSubMenu')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
<form id="editarMenuFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('sites.editarMenu')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
<form id="editarSubMenuFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('sites.editarSubMenu')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
    <input type="hidden" name="id" id="id">
    <div class="modal-dialog modal-lg">
    <div class="modal-content">
...
<form id="editarSubSubMenuFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('sites.editarSubMenu')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
    <input type="hidden" name="id" id="id">
    <div class="modal-dialog modal-lg">
    <div class="modal-content">
...
<form id="adicionarMenuAplicativoFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('sites.adicionarMenuAplicativo')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
    <input type="hidden" name="id_configuracao" value="<?php echo e($site->id_configuracao); ?>">
    <div class="modal-dialog modal-lg">
    <div class="modal-content">
...
<form id="editarMenuAplicativoFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('sites.editarMenuAplicativo')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
    <input type="hidden" name="id" id="id">
    <div class="modal-dialog modal-lg">
    <div class="modal-content">
...
<?php echo $__env->make('layouts.admin_site.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/admin/sites/configuracoes.blade.php ENDPATH**/ ?>