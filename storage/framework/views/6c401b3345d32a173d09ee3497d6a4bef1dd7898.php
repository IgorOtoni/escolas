<?php /* C:\xampp\htdocs\adm_eglise\resources\views\usuario\editarpublicacao.blade.php */ ?>
    ...
    $('input[type=file]').fileinput({
        ...
        initialPreview: [
            <?php foreach($fotos as $foto){ ?>
                "<?php echo e('/storage/galerias-publicacoes/'.$foto->foto); ?>",
            <?php } ?>
        ],
        ...
        initialPreviewConfig: [
            <?php $x = 0; foreach($fotos as $foto){ $x++; ?>
                {caption: "<?php echo e($foto->foto); ?>", extra: {id: <?php echo e($foto->id); ?>, foto: "<?php echo e($foto->foto); ?>", _token: $("#csrf_token").val()}, size: 215000, width: "120px", url: "/usuario/excluirFotoPublicacao", key: <?php echo e($x); ?>},
            <?php } ?>
        ],
            ...
            <div class="box-body">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="html" id="editor" class="form-control"><?php echo e(limpa_html($publicacao->html)); ?></textarea>
                    </div>
                </div>
                </div>
