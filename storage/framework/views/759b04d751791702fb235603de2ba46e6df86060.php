            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="croseNav">
                        ...
                        <!-- Nav brand -->
                        <a href="<?php echo e(route('site.index', ['url' => $site->url])); ?>" class="nav-brand"><img style="witdh: 120px; height: 50px;" src="<?php echo e(($site->logo != null) ? 'data:image;base64,'.base64_encode($site->logo) : asset('/storage/no-logo.jpg')); ?>" alt=""></a><h3><?php echo $site->nome ?></h3>
