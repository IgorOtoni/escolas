            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="croseNav">
                        ...
                        <!-- Nav brand -->
                        <a href="<?php echo e(route('igreja.index', ['url' => $igreja->url])); ?>" class="nav-brand"><img style="witdh: 120px; height: 50px;" src="<?php echo e(($igreja->logo != null) ? 'data:image;base64,'.base64_encode($igreja->logo) : asset('/storage/no-logo.jpg')); ?>" alt=""></a><h3><?php echo $igreja->nome ?></h3>
...
</html><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/layouts/template2.blade.php ENDPATH**/ ?>