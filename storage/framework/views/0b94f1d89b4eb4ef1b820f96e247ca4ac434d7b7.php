<?php /* C:\xampp\htdocs\adm_eglise\resources\views\layouts\template4.blade.php */ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Title -->
                    ...
                    foreach($menus as $menu){
                        if($submenus != null && array_key_exists($menu->id, $submenus) && count($submenus[$menu->id]) > 0){ ?>
                            <li class="list-inline-item g-pos-rel ml-lg-auto"><a id="<?php echo e($dropdowm_name.$x."-invoker"); ?>" href="/<?php echo e($site->url); ?>/<?php echo e(($menu->link != null) ? $menu->link != null : "#"); ?>" class="nav-link g-color-white-opacity-0_7 g-color-white--hover g-font-size-15 g-font-size-17--xl g-px-15--lg g-py-10 g-py-30--lg"
                                ...
                                data-dropdown-target="#<?php echo e($dropdowm_name.$x); ?>"
                                data-dropdown-type="css-animation"
                                data-dropdown-duration="100"
                                data-dropdown-hide-on-scroll="true"
                                data-dropdown-animation-in="fadeIn"
                                data-dropdown-animation-out="fadeOut"><?php echo e($menu->nome); ?><i class="g-ml-3 fa fa-angle-down"></i></a>
                            
                                <ul id="<?php echo e($dropdowm_name.$x); ?>" class="list-unstyled u-shadow-v39 g-brd-around g-brd-4 g-brd-white g-bg-secondary g-pos-abs g-left-0 g-z-index-99 g-mt-5"
                                    aria-labelledby="<?php echo e($dropdowm_name.$x."-invoker"); ?>">
