<?php /* E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/template1/midias.blade.php */ ?>
            ...
            <?php foreach($midias as $midia){ ?>
                <article class="post sermon">
                    ...
                    <div class="row">
                        ...
                        <h3><a href="<?php echo e(route('site.midia', ['url'=>$site->url,'id'=>$midia->id])); ?>"><?php echo e($midia->nome); ?></a></h3>
