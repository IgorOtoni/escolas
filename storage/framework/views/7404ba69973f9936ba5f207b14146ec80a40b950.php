<?php /* E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/template1/sermoes.blade.php */ ?>
            ...
            <?php foreach($sermoes as $sermao){ ?>
                <article class="post sermon">
                    ...
                    <div class="row">
                        ...
                        <h3><a href="<?php echo e(route('igreja.sermao', ['url'=>$igreja->url,'id'=>$sermao->id])); ?>"><?php echo e($sermao->nome); ?></a></h3>
                    ...
                    <div class="row">
                        ...
                        <p><a href="<?php echo e($sermao->link); ?>" class="btn btn-primary">Assistir vídeo <i class="fa fa-long-arrow-right"></i></a></p>
                        </div>
                    </div>
                    </div>
                </article>
