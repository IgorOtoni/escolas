...
<body>
        ...
        <div class="topbar">
            <div class="container">
                <div class="row">
                    ...
                    <h1 class="logo"> <a href="<?php echo e(route('site.index', ['url' => $site->url])); ?>"><img style="witdh: 100px; height: 50px;" src="<?php echo e((($site->logo != null) ? 'data:image;base64,'.base64_encode($site->logo) : '/storage/no-logo.jpg' )); ?>" alt="Logo"></a> </h1>
                    </div>
    ...
    <!-- Jquery Library Call -->
    <script src="<?php echo e(asset('template_site/template-padrao/js/jquery.js')); ?>"></script> 
    <!-- PrettyPhoto Plugin --> 
