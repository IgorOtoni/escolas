	            ...
	            <ul>
	                ...
	                foreach($banners as $banner){
		                ...
		                <li data-transition="random" data-slotamount="7" data-masterspeed="500" data-saveperformance="off" class="texture_bg_slider_full slide1">
		                    <img width="1920" height="630" src="/storage/banners/<?php echo e($banner->foto); ?>" alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="repeat">
		                    <div class="tp-caption titlecentered lfr stb tp-resizeme cust-z-index-5 rs-cust-style7" data-x="center" data-hoffset="0" data-y="center" data-voffset="-40" data-speed="500" data-start="650" data-easing="Power3.easeInOut" data-splitin="lines" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-end="8150" data-endspeed="300"><?php echo e($banner->nome); ?>
		                    ...
		                    <div class="tp-caption slidetextcentered lfl stb tp-resizeme cust-z-index-6 rs-cust-style2" data-x="center" data-hoffset="0" data-y="center" data-voffset="85" data-speed="500" data-start="1000" data-easing="Power3.easeInOut" data-splitin="lines" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-end="8300" data-endspeed="300">
								<span class="font-w_400"><?php echo e($banner->descricao); ?></span>
		                    </div>
		                    <?php
	                        if($banner->link != null){
	                            ?>
...
<?php $__env->startSection('content-x'); ?>
<?php
                            ...
                            <div class="post_content isotope_item_content ih-item colored square effect_shift left_to_right">
                                <div class="post_featured img">
                                    <a href="post-with-sidebar.html">
										<img width="400px" height="400px" alt="" src="/storage/galerias/<?php echo e($foto->foto); ?>">
									</a>
                                </div>
                                <div class="post_info_wrap info">
                                    <div class="info-back">
                                        <h4 class="post_title">
											<a href="/storage/galerias/<?php echo e($foto->foto); ?>"><?php echo e($galeria->nome); ?></a>
										</h4>
                                        <div class="post_descr">
                                            <p>
												<a href="post-with-sidebar.html"><?php echo e($galeria->descricao); ?><br><?php echo e(\Carbon\Carbon::parse($galeria->data)->diffForHumans()); ?></a>
											</p>
                                            <a href="/storage/galerias/<?php echo e($foto->foto); ?>"><span class="hover_icon hover_icon_view"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
							...
							<div class="swiper-slide height_12em width_100per" data-style="width:100%;height:12em;">
								<div class="sc_testimonial_item">
									<div class="sc_testimonial_avatar">
										<img alt="" src="<?php echo e(($evento->foto != null) ? '/storage/timeline/'.$evento->foto : '/storage/no-event.jpg'); ?>"></div>
									<div class="sc_testimonial_content">
										<p><i class="fa fa-calendar"></i> <?php echo e(\Carbon\Carbon::parse($evento->dados_horario_inicio, 'UTC')->isoFormat('Do MMMM YYYY, h:mm:ss A')); ?> - <?php echo e(\Carbon\Carbon::parse($evento->dados_horario_fim)->diffForHumans($evento->dados_horario_inicio)); ?></p>
										<p><?php echo e($evento->dados_local); ?></p>
...
?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template8banner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>