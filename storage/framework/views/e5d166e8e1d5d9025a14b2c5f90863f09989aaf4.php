                            ...
                            <div class="single-upcoming-events-area d-flex flex-wrap align-items-center">
                                ...
                                <div class="upcoming-events-content d-flex flex-wrap align-items-center">
                                    ...
                                    <div class="find-out-more-btn">
                                        <a href="<?php echo e(route('igreja.eventofixo', ['url'=>$igreja->url,'id'=>$evento->id])); ?>" class="btn crose-btn btn-2">Ver em detalhe</a>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.template2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/template2/eventosfixos.blade.php ENDPATH**/ ?>