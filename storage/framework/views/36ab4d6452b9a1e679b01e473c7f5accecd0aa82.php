<?php /* C:\xampp\htdocs\adm_eglise\resources\views/usuario/banners.blade.php */ ?>
        ...
        <!-- form start -->
            ...
            <div class="box-body">
                ...
                <div id="midias_area" class="col-md-12">
                    <div class="form-group has-feedback">
                    <label >Sermões</label>
                    <select id="midias" name="midias" class="form-control select2" style="width: 100%;" required>
