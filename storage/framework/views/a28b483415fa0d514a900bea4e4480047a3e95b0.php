<?php /* C:\xampp\htdocs\apresentacao_sites\resources\views/layouts/template2.blade.php */ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="croseNav">
                        ...
                        <!-- Nav brand -->
                        <a href="/<?php echo e($site->url); ?>" class="nav-brand"><img style="witdh: 120px; height: 50px;" src="<?php echo e(asset('/storage/'.(($site->logo != null) ? 'sites/'.$site->logo : 'no-logo.jpg' ))); ?>" alt=""></a><h3><?php echo $site->nome ?></h3>
