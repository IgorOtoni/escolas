...
function switch_status(comp){
  ...
  $.ajax({
    url: '<?php echo e(route('usuario.switchStatusUsuario', ['id'=>''])); ?>/'+id,
    type: 'GET'
  });
...
$(function () {
  ...
  var table = $('#tbl_usuarios').DataTable({
    ...
    'autoWidth': false,
    //'serverSide': false,
    'ajax': '<?php echo e(route('usuario.tbl_usuarios')); ?>',
    'columns': [
            {
...
<div class="modal fade" id="modal-incluir">
  <form id="incluirUsuarioFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('usuario.incluirUsuario')); ?>" enctype="multipart/form-data">
  <?php echo csrf_field(); ?>
