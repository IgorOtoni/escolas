<?php /* C:\xampp\htdocs\apresentacao_sites\resources\views/admin/perfis/index.blade.php */ ?>
...
$("#site").on("change", function(){
  ...
  if(id_site > 0){
    $.ajax({
        url: '/admin/sites/carregarModulos/'+id_site,
        type: 'get',
        dataType: 'json',
...
<div class="modal fade" id="modal-incluir">
  <form id="incluirPerfilFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('perfis.incluir')); ?>" enctype="multipart/form-data">
  <?php echo csrf_field(); ?>
                  ...
                  <div class="col-md-12">
                    <div class="form-group has-feedback">
                      ...
                      <select id="site" name="site" class="form-control" required>
                        ...
                        <?php $sites = App\TblSite::orderBy('nome','ASC')->get(); ?>
