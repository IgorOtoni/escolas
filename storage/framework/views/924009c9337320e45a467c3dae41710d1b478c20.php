          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo e(route('admin.account')); ?>" class="btn btn-default btn-flat">Conta</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo e(route('admin.home')); ?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
        <li><a href="<?php echo e(route('igrejas')); ?>"><i class="fa fa-institution "></i> <span>Sites</span></a></li>
        <li><a href="<?php echo e(route('perfis')); ?>"><i class="fa fa-users"></i> <span>Perfis</span></a></li>
        <li><a href="<?php echo e(route('usuarios')); ?>"><i class="fa fa-user"></i> <span>Usuários</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
...
<?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/layouts/admin_site/index.blade.php ENDPATH**/ ?>