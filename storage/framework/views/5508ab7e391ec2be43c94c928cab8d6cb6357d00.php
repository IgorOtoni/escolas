<?php /* E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/eglise/igrejas.blade.php */ ?>
        ...
        <div class="attachment-pushed" style="word-wrap: break-word; overflow-wrap: break-word;">
            <h4 class="attachment-heading">
                <?php if($igreja->url != null && $igreja->status == true): ?>
                    <a href="<?php echo e(($igreja->url != null && $igreja->status == true) ? "/".$igreja->url: "#"); ?>"><?php $igreja->nome ?></a>
                <?php else: ?>
                    <?php $igreja->nome ?>
                <?php endif; ?>
            </h4>
