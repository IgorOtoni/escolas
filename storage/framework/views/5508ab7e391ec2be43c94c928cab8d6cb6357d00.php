<?php /* E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/eglise/sites.blade.php */ ?>
        ...
        <div class="attachment-pushed" style="word-wrap: break-word; overflow-wrap: break-word;">
            <h4 class="attachment-heading">
                <?php if($site->url != null && $site->status == true): ?>
                    <a href="<?php echo e(($site->url != null && $site->status == true) ? "/".$site->url: "#"); ?>"><?php $site->nome ?></a>
                <?php else: ?>
                    <?php $site->nome ?>
                <?php endif; ?>
            </h4>
