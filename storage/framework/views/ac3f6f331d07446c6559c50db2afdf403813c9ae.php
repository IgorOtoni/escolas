    ...
    $('input[type=file]').fileinput({
        ...
        initialPreview: [
            <?php if($membro->foto != null){ ?>
                "<?php echo e('data:image;base64,'.base64_encode($membro->foto)); ?>",
            <?php } ?>
        ],
        ...
        initialPreviewConfig: [
            <?php if($membro->foto != null){ ?>
                {caption: "<?php echo e($membro->foto); ?>", extra: {id: <?php echo e($membro->id); ?>, foto: "<?php echo e($membro->foto); ?>", _token: $("#csrf_token").val()}, size: 215000, width: "120px", url: "<?php echo e(route('usuario.excluirFotoMembro')); ?>", key: 1},
            <?php } ?>
        ],
        ...
        <?php echo csrf_field(); ?>
            ...
            <div class="box">
                ...
                <div class="box-footer">
                    <a href="<?php echo e(route('usuario.membros')); ?>" class="btn btn-warning pull-left">Cancelar</a>
