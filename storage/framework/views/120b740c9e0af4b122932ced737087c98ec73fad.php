...
<body>
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="faithNav">
                        ...
                        <!-- Logo -->
                        <a class="nav-brand" href="<?php echo e(route('site.index', ['url' => $site->url])); ?>"><img style="witdh: 120px; height: 50px;" src="<?php echo e(($site->logo != null) ? 'data:image;base64,'.base64_encode($site->logo) : asset('/storage/no-logo.jpg')); ?>" alt=""></a><h3><?php echo $site->nome ?></h3></a>
    ...
    <footer class="footer-area">
        <!-- Main Footer Area -->
        <div class="main-footer-area section-padding-100-0 bg-img foo-bg-overlay" style="background-image: url(<?php echo e(asset('template_site/template-escuro/img/bg-img/bg-9.jpg')); ?>);">
            <div class="container">
                <div class="row">
                    <!-- Footer Widget Area -->
