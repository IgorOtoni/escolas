<?php /* C:\xampp\htdocs\adm_eglise\resources\views/layouts/template1/index.blade.php */ ?>
        ...
        <div class="tp-banner">
            <ul style="display:none;">
                ...
                foreach($banners as $banner){
                    ?>
                    <!-- SLIDE  -->
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1000"  data-saveperformance="off" data-title="<?php echo e($x++); ?>">
                        <!-- MAIN IMAGE -->
                        <img src="/storage/banners/<?php echo e($banner->foto); ?>"  alt="fullslide1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                    ...
                    data-endspeed="300" 
                            ...
                            style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;"><?php echo e($banner->nome); ?> 
                        </div>
                        <?php
                        if($banner->link != null){
                            ?> </a> <?php
                    ...
                    data-endspeed="300" 
                            ...
                            style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap;"><?php echo e($banner->descricao); ?> 
                        </div>
                        <?php
                        if($banner->link != null){
                            ?> </a> <?php
            ...
            foreach($eventos as $evento){
                ...
                <li class="<?php echo e($class); ?>">
                    ...
                    <div class="timeline-heading">
                        ...
                        <a data-toggle="modal" data-target="#modal-evento" data-foto="<?php echo e($evento->foto); ?>" data-local="<?php echo e($evento->dados_local); ?>" data-nome="<?php echo e($evento->nome); ?>" data-descricao="<?php echo e($evento->descricao); ?>" data-inicio="<?php echo e(\Carbon\Carbon::parse($evento->dados_horario_inicio, 'UTC')->isoFormat('Do MMMM YYYY, h:mm:ss A')); ?>" data-fim="<?php echo e((($evento->dados_horario_fim != null) ? \Carbon\Carbon::parse($evento->dados_horario_fim)->diffForHumans($evento->dados_horario_inicio) : '')); ?>"><?php echo e($evento->nome); ?></a>
                        </h3>
                    </div>
