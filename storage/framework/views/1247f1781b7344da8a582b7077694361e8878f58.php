<?php /* C:\xampp\htdocs\apresentacao_sites\resources\views/template5/eventos.blade.php */ ?>
            ...
            <div class="post-list blog-posts">
            	<?php foreach($eventos as $evento){ ?>
	                <div class="post" style="min-height: 225px;">
	                    ...
	                    <h2 class="title"><a href="/<?php echo e($site->url); ?>/evento/<?php echo e($evento->id); ?>"><?php echo e($evento->nome); ?></a></h2>
	                    <p class="meta">
	                    ...
	                    <p class="actions">
	                    	<a href="/<?php echo e($site->url); ?>/evento/<?php echo e($evento->id); ?>" class="read-more">Detalhes<span class="circle-arrow"></span></a>
	                    </p>
	                </div>
            	<?php } ?>
