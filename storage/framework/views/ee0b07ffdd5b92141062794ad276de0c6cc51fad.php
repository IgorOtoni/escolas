<?php /* C:\xampp\htdocs\adm_eglise\resources\views/layouts/template3/index.blade.php */ ?>
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            ...
            foreach($banners as $banner){
                ...
                ?>
                <!-- Single Hero Slide -->
                <div class="single-hero-slide bg-img bg-overlay" style="background-image: url(storage/<?php echo e((($banner->foto != null) ? "banners/".$banner->foto : "no-event.jpg")); ?>);">
