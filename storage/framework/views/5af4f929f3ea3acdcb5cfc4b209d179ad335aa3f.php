...
$(function(){
    ...
    var table = $('#tbl_comunidades').DataTable({
        ...
        'autoWidth': false,
        //'serverSide': false,
        'ajax': '<?php echo e(route('usuario.tbl_comunidades')); ?>',
        'columns': [
                {
                ...
                <tbody>
                    ...
                    foreach($membros as $membro){
                        ...
                        <tr>
                            ...
                            <td><input name="membros[]" value="<?php echo e($membro->id); ?>" type="checkbox"></td>
                            <td><input name="lideres[]" value="<?php echo e($membro->id); ?>" type="checkbox"></td>
                        <?php
                    }
                    ?>
                </tbody>
...
<?php echo $__env->make('layouts.usuario.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/usuario/comunidades.blade.php ENDPATH**/ ?>