...
if($banners != null && sizeof($banners)){
    ...
    <section class="hero-area hero-post-slides owl-carousel">
        ...
        foreach($banners as $banner){
            ...
            ?>
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img bg-overlay d-flex align-items-center justify-content-center" style="background-image: url(<?php echo e((($banner->foto != null) ? 'data:image;base64,'.base64_encode($banner->foto) : asset('/storage/no-event.jpg'))); ?>);">
                <!-- Post Content -->
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                ...
                                <p data-animation="fadeInUp" data-delay="300ms"><?php echo e($banner->descricao); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-blog-post mb-100">
                            ...
                            <div class="post-content">
                                ...
                                <?php */ ?>
                                <a href="<?php echo e(route('site.noticia', ['url'=>$site->url,'id'=>$noticia->id])); ?>"><h4><?php echo e($noticia->nome); ?></h4></a>
                                ...
                                <p class="post-excerpt"><?php echo e($noticia->descricao); ?></p>
                            </div>
                        </div>
                    </div>
                <?php } ?>
                                ...
                                <div class="single-upcoming-events-area d-flex flex-wrap align-items-center">
                                    ...
                                    <div class="upcoming-events-content d-flex flex-wrap align-items-center">
                                        ...
                                        <div class="find-out-more-btn">
                                            ...
                                            <?php */ ?>
                                            <a href="<?php echo e(route('site.evento', ['url'=>$site->url,'id'=>$evento->id])); ?>" class="btn crose-btn btn-2">Ver em detalhe</a>
                                        </div>
                                    </div>
                                </div>
                ...
                foreach($fotos_ as $foto){ ?>
                    ...
                    <div class="single-gallery-area">
                        <a href="<?php echo e('data:image;base64,'.base64_encode($foto->foto)); ?>" class="gallery-img" title="<?php echo e($galeria->nome); ?>">
                            <img src="<?php echo e('data:image;base64,'.base64_encode($foto->foto)); ?>" alt="">
                        </a>
                    </div>
                <?php } ?>
            </div>
...
<?php echo $__env->make('layouts.template2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/template2/index.blade.php ENDPATH**/ ?>