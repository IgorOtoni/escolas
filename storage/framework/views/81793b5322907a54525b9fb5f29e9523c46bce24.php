<?php /* C:\xampp\htdocs\apresentacao_sites\resources\views/layouts/template2/midiadetalhado.blade.php */ ?>
            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="/<?php echo e($site->url); ?>/midias">Vídeos</a></li>
                ...
                <div class="sermons-details-area">
                    ...
                    <div class="single-post-details-area">
                        <div class="post-content">
                            ...
                            <iframe style="width: 100%; min-height: 400px;" frameborder="0" src="<?php echo e($midia->link); ?>"></iframe>
