...
function switch_status(comp){
  ...
  $.ajax({
    url: '<?php echo e(route('usuario.switchStatusPerfil', ['id'=>''])); ?>/'+id,
    type: 'GET'
  });
...
$(function(){
    ...
    $.ajax({
        url: '<?php echo e(route('usuario.carregarModulosIgreja', ['id'=>''])); ?>/'+<?php echo e($igreja->id); ?>,
        type: 'get',
        dataType: 'json',
...
$(function () {
    ...
    'autoWidth': false,
    //'serverSide': false,
    'ajax': '<?php echo e(route('usuario.tbl_perfis')); ?>',
    'columns': [
            {
...
<?php echo $__env->make('layouts.usuario.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/usuario/perfis.blade.php ENDPATH**/ ?>