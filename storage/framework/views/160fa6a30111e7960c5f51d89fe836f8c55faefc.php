...
<section class="content">
    ...
    <div class="box-footer">
        <a href="<?php echo e(route('usuario.comunidades')); ?>" class="btn btn-warning pull-left">Voltar</a>
    </div>
    <!-- /.box-footer-->
    </div>
    <!-- /.box -->
...
<?php echo $__env->make('layouts.usuario.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/usuario/reunioes.blade.php ENDPATH**/ ?>