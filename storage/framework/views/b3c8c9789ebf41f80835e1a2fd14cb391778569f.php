    ...
    $('input[type=file]').fileinput({
        ...
        initialPreview: [
            <?php if($eventofixo->foto != null){ ?>
                "<?php echo e('data:image;base64,'.base64_encode($eventofixo->foto)); ?>",
            <?php } ?>
        ],
        ...
        initialPreviewConfig: [
            <?php if($eventofixo->foto != null){ ?>
                {caption: "<?php echo e($eventofixo->foto); ?>", extra: {id: <?php echo e($eventofixo->id); ?>, foto: "<?php echo e($eventofixo->foto); ?>", _token: $("#csrf_token").val()}, size: 215000, width: "120px", url: "route('usuario.excluirFotoEventoFixo')", key: 1},
            <?php } ?>
        ],
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-footer">
                <a href="<?php echo e(route('usuario.eventosfixos')); ?>" class="btn btn-warning pull-left">Cancelar</a>
...
<?php echo $__env->make('layouts.usuario.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/usuario/editareventofixo.blade.php ENDPATH**/ ?>