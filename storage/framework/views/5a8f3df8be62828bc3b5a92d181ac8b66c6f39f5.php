            ...
            <div class="blog-posts-area">
                ...
                <div class="single-post-details-area">
                    ...
                    <div class="post-thumbnail mb-30">
                        ...
                        <img src="<?php echo e(($noticia->foto != null) ? 'data:image;base64,'.base64_encode($noticia->foto) : asset('/storage/no-news.jpg')); ?>" alt="">
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.template1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/template1/noticiadetalhada.blade.php ENDPATH**/ ?>