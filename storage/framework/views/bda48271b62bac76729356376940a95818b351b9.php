<?php /* C:\xampp\htdocs\adm_eglise\resources\views\publicacoes\index.blade.php */ ?>
...
<form id="incluirPublicacoesFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('publicacoes.incluir')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
