<?php /* E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/template1/apresentacao.blade.php */ ?>
                ...
                <div class="grid-item staff-item">
                    ...
                    <div class="media-box"> 
                        <?php if($membro->foto != null): ?>
                            <img width="250" height="250" src="<?php echo e('data:image;base64,'.base64_encode($membro->foto)); ?>" alt=""> 
                        <?php else: ?>
