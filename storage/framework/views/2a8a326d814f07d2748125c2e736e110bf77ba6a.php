<?php /* C:\xampp\htdocs\apresentacao_escolas\resources\views/layouts/template2/index.blade.php */ ?>
...
if($banners != null && sizeof($banners)){
    ...
    <section class="hero-area hero-post-slides owl-carousel">
        ...
        foreach($banners as $banner){
            ...
            ?>
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img bg-overlay d-flex align-items-center justify-content-center" style="background-image: url(storage/<?php echo e((($banner->foto != null) ? "banners/".$banner->foto : "no-event.jpg")); ?>);">
                <!-- Post Content -->
                <div class="container">
                    <div class="row">
                        <div class="col-12">
