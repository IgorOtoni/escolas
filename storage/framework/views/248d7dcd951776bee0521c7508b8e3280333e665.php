<?php /* E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/usuario/editarevento.blade.php */ ?>
                ...
                <tbody>
                    ...
                    if(isset($inscricoes) && sizeof($inscricoes) > 0) foreach($inscricoes as $inscricao){
                        ...
                        <tr>
                            ...
                            <td><input name="inscricoes[]" value="<?php echo e($inscricao->id); ?>" type="checkbox" <?php echo e(($inscricao->cancelada) ? "checked" : ""); ?>></td>
                        <?php
                    }
                    ?>
                </tbody>
