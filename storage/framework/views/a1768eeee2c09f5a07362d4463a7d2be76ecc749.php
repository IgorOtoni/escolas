<?php /* C:\xampp\htdocs\adm_eglise\resources\views/layouts/template2/apresentacao.blade.php */ ?>
                    ...
                    <?php $__currentLoopData = $membros[$funcao->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            <div class="single-team-members text-center mb-100">
                                <div class="team-thumb" style="background-image: url(<?php echo e(asset('/storage/'.($membro->foto != null ? 'membros/'.$membro->foto : 'no-foto.png'))); ?>);">
