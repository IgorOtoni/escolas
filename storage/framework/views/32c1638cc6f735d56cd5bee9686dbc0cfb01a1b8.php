...
$(function(){
    ...
    var table = $('#tbl_membros').DataTable({
        ...
        'autoWidth': false,
        //'serverSide': false,
        'ajax': '<?php echo e(route('usuario.tbl_membros')); ?>',
        'columns': [
                {
...
<?php echo $__env->make('layouts.usuario.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/usuario/membros.blade.php ENDPATH**/ ?>