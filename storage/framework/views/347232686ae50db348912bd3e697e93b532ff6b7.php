<?php /* C:\xampp\htdocs\apresentacao_escolas\resources\views/template7/sermaodetalhado.blade.php */ ?>
                ...
                <div class="page__blog__details">
                    <article class="dacre__blog__details">
                        <div class="blog__thumb">
                            <iframe width="839" height="600" frameborder="0" src="<?php echo e($sermao->link); ?>"></iframe>
                        </div>
                        <div class="blog__inner">
                            <h2><?php echo e($sermao->nome); ?></h2>
                            <ul>
                                <li>Adicionado <?php echo e(\Carbon\Carbon::parse($sermao->created_at)->diffForHumans()); ?></li>
                            </ul>
