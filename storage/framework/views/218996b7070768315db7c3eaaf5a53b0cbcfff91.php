<?php /* E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/usuario/eventosfixos.blade.php */ ?>
...
$(function(){
    ...
    var table = $('#tbl_eventosfixos').DataTable({
        ...
        'autoWidth': false,
        //'serverSide': false,
        'ajax': '<?php echo e(route('usuario.tbl_eventosfixos')); ?>',
        'columns': [
                {
...
<form id="incluirEventoFixoFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('usuario.incluirEventoFixo')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
