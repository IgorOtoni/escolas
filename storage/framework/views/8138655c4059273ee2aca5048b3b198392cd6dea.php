            ...
            <ul style="display:none;">
                ...
                foreach($banners as $banner){
                    ...
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1000"  data-saveperformance="off" data-title="<?php echo e($x++); ?>">
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo e('data:image;base64,'.base64_encode($banner->foto)); ?>"  alt="fullslide1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
            ...
            <ul class="grid-holder col-3 events-grid">
                <?php foreach($noticias as $noticia){ ?>
                    ...
                    <div class="grid-item-inner">  
                        ...
                        <?php */ ?>
                        <h3><a href="<?php echo e(route('igreja.noticia', ['url'=>$igreja->url,'id'=>$noticia->id])); ?>"><?php echo $noticia->nome ?></a></h3>
            ...
            for($x_ = sizeof($eventos) - 1; $x_ >= 0; $x_--){
                ...
                <li class="<?php echo e($class); ?>">
                    ...
                    <div class="timeline-heading">
                        ...
                        <a href="<?php echo e(route('igreja.evento', ['url'=>$igreja->url,'id'=>$evento->id])); ?>"><?php echo $evento->nome ?></a>
                        </h3>
                    </div>
...
<?php echo $__env->make('layouts.template1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/template1/index.blade.php ENDPATH**/ ?>