<?php /* E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/usuario/funcoes.blade.php */ ?>
...
$(function(){
    ...
    var table = $('#tbl_funcoes').DataTable({
        ...
        'autoWidth': false,
        //'serverSide': false,
        'ajax': '<?php echo e(route('usuario.tbl_funcoes')); ?>',
        'columns': [
                {
...
<form id="incluirFuncaoFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('usuario.incluirFuncao')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
            ...
            <div class="box-body">
                ...
                <div class="col-md-12">
                    <div class="form-group has-feedback">
                        <div class="radio">
                            <label>
                                <input name="apresentar" type="radio">
