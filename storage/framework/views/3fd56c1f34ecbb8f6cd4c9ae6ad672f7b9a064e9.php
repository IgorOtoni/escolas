        ...
        echo '<td width="20%">';
            ...
            echo '<table width="100%">';
                echo '<tr width="100%">';
                    ...
                    echo '<td width="100%">';
                    echo '<center><img class="img-thumbnail" width="100px" height="100px" src="data:image;base64,'.base64_encode($produto->icone).'"></center>';
                    echo '</td>';
            ...
            <form method="post">
                <div class="bggray">
                    <div class="form_settings">
                        <center>
                            <a href="<?php echo e(route('igreja.limparCarrinho', $igreja->url)); ?>" class="btn btn-danger">Cancelar compra</a>
                            <a class="btn btn-info" href="<?php echo e(route('igreja.finalizarCompra', $igreja->url)); ?>">Finalizar compra</a>
                        </center>
                    </div>
                </div>
            </form>
...
<?php echo $__env->make('layouts.carrinho', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/carrinho/carrinho.blade.php ENDPATH**/ ?>