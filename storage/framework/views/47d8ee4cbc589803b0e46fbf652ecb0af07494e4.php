...
$(function(){
    ...
    $('input[type=file]').fileinput({
        ...
        initialPreview: [
            "<?php echo e('data:image;base64,'.base64_encode($banner->foto)); ?>",
        ],
        ...
        initialPreviewConfig: [
            {caption: "<?php echo e($banner->foto); ?>", extra: {id: <?php echo e($banner->id); ?>, foto: "<?php echo e($banner->foto); ?>", _token: $("#csrf_token").val()}, size: 215000, width: "120px", url: "<?php echo e(route('usuario.excluirFotoBanner')); ?>", key: 1},
        ],
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-footer">
                <a href="<?php echo e(route('usuario.banners')); ?>" class="btn btn-warning pull-left">Cancelar</a>
...
<?php echo $__env->make('layouts.usuario.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/usuario/editarbanner.blade.php ENDPATH**/ ?>