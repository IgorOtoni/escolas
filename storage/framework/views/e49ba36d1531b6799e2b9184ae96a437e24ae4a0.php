<?php /* C:\xampp\htdocs\adm_eglise\resources\views\layouts\template2\eventofixodetalhado.blade.php */ ?>
            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="/<?php echo e($igreja->url); ?>/eventofixos">Eventos fixos</a></li>
