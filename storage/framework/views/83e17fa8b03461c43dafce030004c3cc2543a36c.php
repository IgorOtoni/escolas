                        ...
                        <div class="single-sermons">
                            <div class="sermons-content d-flex align-items-center">
                                ...
                                <div class="sermons-text">
                                    <a href="<?php echo e(route('site.midia', ['url'=>$site->url,'id'=>$midia->id])); ?>">
...
<?php echo $__env->make('layouts.template3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/template3/midias.blade.php ENDPATH**/ ?>