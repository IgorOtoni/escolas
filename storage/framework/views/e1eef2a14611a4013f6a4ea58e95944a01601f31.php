    ...
    $('#input_img').fileinput({
        ...
        initialPreview: [
            <?php if($produto->icone != null){ ?>
                "<?php echo e('data:image;base64,'.base64_encode($produto->icone)); ?>",
            <?php } ?>
        ],
        ...
        initialPreviewConfig: [
            <?php if($produto->icone != null){ ?>
                {caption: "<?php echo e($produto->icone); ?>", extra: {id: <?php echo e($produto->id); ?>, foto: "<?php echo e($produto->icone); ?>", _token: $("#csrf_token").val()}, size: 215000, width: "120px", url: "<?php echo e(route('usuario.excluirIconeProduto')); ?>", key: 1},
            <?php } ?>
        ],
    ...
    $('#input_img_').fileinput({
        ...
        initialPreviewConfig: [
            <?php $x = 0; foreach($fotos as $foto){ $x++; ?>
                {caption: "<?php echo e($foto->foto); ?>", extra: {id: <?php echo e($foto->id); ?>, foto: "<?php echo e($foto->foto); ?>", _token: $("#csrf_token").val()}, size: 215000, width: "120px", url: "<?php echo e(route('usuario.excluirFotoProduto')); ?>", key: <?php echo e($x); ?>},
            <?php } ?>
        ],
        overwriteInitial: false,
        //purifyHtml: true,
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-footer">
            <a href="<?php echo e(route('usuario.produtos')); ?>" class="btn btn-warning pull-left">Cancelar</a>
...
<?php echo $__env->make('layouts.usuario.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/usuario/editarProduto.blade.php ENDPATH**/ ?>