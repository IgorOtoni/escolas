<?php /* E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/usuario/noticias.blade.php */ ?>
...
$(function(){
    ...
    var table = $('#tbl_noticias').DataTable({
        ...
        'autoWidth': false,
        //'serverSide': false,
        'ajax': '<?php echo e(route('usuario.tbl_noticias')); ?>',
        'columns': [
                {
...
<section class="content-header">
    <h1>
    Notícias
    <small>Lista de todas as notícias</small>
    </h1>
</section>
...
<form id="incluirNoticiaFormulario" data-toggle="validator" method="POST" role="form" action="<?php echo e(route('usuario.incluirNoticia')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
