<?php /* E:\Programacao\usbwebserver_v8.6.2\root\Gratunos\resources\views/usuario/editargaleria.blade.php */ ?>
    ...
    $('input[type=file]').fileinput({
        ...
        initialPreviewConfig: [
            <?php $x = 0; foreach($fotos as $foto){ $x++; ?>
                {caption: "<?php echo e($foto->foto); ?>", extra: {id: <?php echo e($foto->id); ?>, foto: "<?php echo e($foto->foto); ?>", _token: $("#csrf_token").val()}, size: 215000, width: "120px", url: "<?php echo e(route('usuario.excluirFotoGaleria')); ?>", key: <?php echo e($x); ?>},
            <?php } ?>
        ],
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-footer">
                <a href="<?php echo e(route('usuario.galerias')); ?>" class="btn btn-warning pull-left">Cancelar</a>
