...
@section('content')
  ...
  <div class="modal fade" id="modal-configuracoes">
    <form id="configuracoesSiteFormulario" data-toggle="validator" method="POST" role="form" action="{{route('sites.salvarConfiguracoes')}}" enctype="multipart/form-data">
    @csrf
  ...
  <div class="modal fade" id="modal-incluir">
    <form id="incluirSiteFormulario" data-toggle="validator" method="POST" role="form" action="{{route('sites.incluir')}}" enctype="multipart/form-data">
    @csrf
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
