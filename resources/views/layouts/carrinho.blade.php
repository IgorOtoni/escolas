			    ...
			    <div class="navbar-header">
		          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
		            ...
		            <span class="icon-bar"></span>
		          	...
		          	<!--<a href="{{route('site.index',['url'=>$site->url])}}" class="navbar-brand"><?php echo $site->nome ?></a>-->
			    	<a class="navbar-brand" href="{{route('site.index',['url'=>$site->url])}}">
			    		<img style="border-radius: 5px; width: 100px; height: 100%;" src="{{'data:image;base64,'.base64_encode($site->logo)}}">
			    	</a>
		        </div>
			    <div id="navbar" class="navbar-collapse collapse">
				    <ul class="nav navbar-nav">
				        ...
				        if(!isset(\Auth::user()->id_perfil)){
				            ?>
				            <li><a href="{{route('site.produtos',['url'=>$site->url])}}">Produtos</a></li>
				            <li><a href="{{route('site.carrinho',['url'=>$site->url])}}">Carrinho</a></li>
				            <form data-toggle="validator" method="post" action="{{ route('autenticar_', $site->url) }}" class="navbar-form navbar-right">
			            	@csrf
					            ...
					            <a href="/{{ $site->url }}/cadastro" class="btn btn-info">Cadastrar</a>
					        </form>
				            <?php
				        }else{
				            ?>
				      	...
				      	<ul class="nav navbar-nav navbar-right">
				      		...
				      		<li class="dropdown">
					      		...
					      		<ul class="dropdown-menu" role="menu">
						        	<li><a href="{{ route('comprador.compras',['url'=>$site->url]) }}">Minha compras</a></li>
						        	<li><a href="{{ route('comprador.conta',['url'=>$site->url]) }}">Meus dados</a></li>
						        	<li class="divider"></li>
						        	<li><a href="{{ route('comprador.desativar_conta',['url'=>$site->url]) }}">Desativar conta</a></li>
						        	<li class="divider"></li>
				          	...
				          	<div class="sidebar-module sidebar-module-inset">
					            ...
					            <div class="row">
									<div class="col-md-12">
										...
										<h3>{{$site->nome}}</h3>
										<img width="100%" class="img-thumbnail" src="{{'data:image;base64,'.base64_encode($site->logo)}}">
										</a>
										</center>
									</div>
								</div>
