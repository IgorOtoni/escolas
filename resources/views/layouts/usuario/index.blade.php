...
<body class="hold-transition skin-{{($site->cor != null) ? $site->cor : 'blue'}} sidebar-mini">
<!-- Site wrapper -->
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{($site->logo != null) ? 'data:image;base64,'.base64_encode($site->logo) : '/storage/no-logo.jpg'}}" class="img" alt="User Image">
        </div>
