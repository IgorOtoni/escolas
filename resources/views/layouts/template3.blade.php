...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{asset('template_site/template-escuro/img/core-img/favicon.ico')}}">
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="faithNav">
                        ...
                        <!-- Logo -->
                        <a class="nav-brand" href="{{route('site.index', ['url' => $site->url])}}"><img style="witdh: 120px; height: 50px;" src="{{($site->logo != null) ? 'data:image;base64,'.base64_encode($site->logo) : asset('/storage/no-logo.jpg')}}" alt=""></a><h3><?php echo $site->nome ?></h3></a>
