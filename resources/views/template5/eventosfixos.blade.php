            ...
            <div class="post-list blog-posts">
            	<?php foreach($eventos_fixos as $evento){ ?>
	                <div class="post" style="min-height: 225px;">
	                    ...
	                    <h2 class="title"><a href="/{{$igreja->url}}/eventofixo/{{$evento->id}}">{{$evento->nome}}</a></h2>
	                    <p class="meta">
	                    ...
	                    <p class="actions">
	                    	<a href="/{{$igreja->url}}/eventofixo/{{$evento->id}}" class="read-more">Detalhes<span class="circle-arrow"></span></a>
	                    </p>
	                </div>
            	<?php } ?>
