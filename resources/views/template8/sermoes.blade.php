                	...
                	<?php for($x = 0; $x < sizeof($sermoes); $x += 2){
						...
						<div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2">
							<div class="column-1_2 sc_column_item sc_column_item_1 odd first">
								<h4 class="sc_title sc_title_regular margin_top_0 margin_bottom_075em">{{ $sermao_1->nome }}</h4>
								<div class="sc_video_player">
									<iframe alt="" width="515" height="290" src="{{ $sermao_1->link }}"></iframe>
								</div>
							</div>
							<?php if($sermao_2 != null) { ?>
								<div class="column-1_2 sc_column_item sc_column_item_2 even">
									<h4 class="sc_title sc_title_regular margin_top_0 margin_bottom_075em">{{ $sermao_2->nome }}</h4>
									<div class="sc_video_player">
										<iframe alt="" width="515" height="290" src="{{ $sermao_2->link }}"></iframe>
									</div>
								</div>
							<?php } ?>
						</div>
