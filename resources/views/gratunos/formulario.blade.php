...
<div class="container">
    ...
    <form id="cadastrarSiteForm" method="POST" role="form" action="{{route('plataforma.incluirSite')}}" enctype="multipart/form-data">
    @csrf
                ...
                foreach($templates as $template){
                    ...
                    <div class="lightgallery" style="margin: 15px;">
                        ...
                        foreach($fotos_template as $foto){
                            ...
                            ?>
                            <a href="{{'data:image;base64,'.base64_encode($foto->foto)}}">
                                <img src="{{'data:image;base64,'.base64_encode($foto->foto)}}" class="mySlides-{{$template->id}}" style="border: #0c3d54 1px solid; width: 60%; height: 400px; display: none;" />
                            </a>
                            <?php
                        }
                        ?>
