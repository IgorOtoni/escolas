...
$(function(){
    ...
    var table = $('#tbl_categorias').DataTable({
        ...
        'autoWidth': false,
        //'serverSide': false,
        'ajax': '{{route('usuario.tbl_categorias')}}',
        'columns': [
                {
    ...
    $('#tbl_categorias tbody').on('click', 'td.details-control', function () {
...
<section class="content-header">
    <h1>
    Categorias
    <small>Lista de todas as categorias</small>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box-header with-border">
        ...
        <?php if( valida_permissao(\Auth::user()->id_perfil, \Config::get('constants.modulos.carrinhog'), \Config::get('constants.permissoes.incluir'))[2] == true){ ?>
            ...
            <a class="btn btn-success" data-toggle="modal" data-target="#modal-incluir"><i class="fa fa-plus"></i>&nbspIncluir categoria</a>
            </div>
        <?php } ?>
    </div>
    <div class="box-body">
        <table id="tbl_categorias" class="table table-bordered table-striped">
        <thead>
        <tr>
            <th>Expandir</th>
            <th>#</th>
...
<form id="incluirCategoriaFormulario" data-toggle="validator" method="POST" role="form" action="{{route('usuario.incluirCategoria')}}" enctype="multipart/form-data">
@csrf
